...
var seedPermissionsData = []SysPermission{
	...
	{Code: "helm:view", Module: "helm", Action: "view", Name: "查看 Helm", Description: "查看 Helm release、修订历史与制品仓库"},
	{Code: "helm:install", Module: "helm", Action: "install", Name: "安装/升级 Helm", Description: "通过 Helm 安装或升级应用，以及添加/更新制品仓库"},
...
var seedRolesData = []seedRoleDef{
	...
	},
	{
		...
		Perms: []string{
			...
			"helm:view", "helm:install", "helm:uninstall", "helm:rollback",
			"plugin:list",
		},
	},
	{
